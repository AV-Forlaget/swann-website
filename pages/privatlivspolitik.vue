<template>
  <section class="main-content">
    <div class="default-page default-page--no-flex">
        <h1>Cookie-, GDPR-, og privatlivs- politik</h1>
    ...
    <div class="content-section">
        <div class="content-section__wrapper">
            <div class="content-block">
            <h2>Cookies</h2>
            <p>Websitet anvender ”cookies”, der er en tekstfil, som gemmes på din computer, mobil el. tilsvarende med det formål at genkende den, huske indstillinger, udføre statistik og målrette annoncer. Cookies kan ikke indeholde skadelig kode som f.eks. virus. Det er muligt at slette eller blokere for cookies. Se vejledning: http://minecookies.org/cookiehandtering Hvis du sletter eller blokerer cookies vil annoncer kunne blive mindre relevante for dig og optræde hyppigere. Du kan desuden risikere at websitet ikke fungerer optimalt samt at der er indhold, du ikke kan få adgang til. Websitet indeholder cookies fra tredjeparter, der i varierende omfang kan omfatte:</p>
            <table>
              <thead>
                <tr>
                  <td>Navn </td> <td>Formål </td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>_ga </td> <td>Registrerer et unikt ID, der an ven des til at føre statistik over hvordan den besøgende bruger hjemmesiden. </td>
                </tr>
                <tr>
                  <td>_gat </td> <td>Anvendes af Google Analytics til at drosle hastigheden på antallet af forespørgsler til serveren </td>
                </tr>
                <tr>
                  <td>_gid </td> <td>Registrerer et unikt ID, der an ven des til at føre statistik over hvordan den besøgende bruger hjemmesiden.  </td>
                </tr>
                <tr>
                  <td>Collect </td> <td>Bruges til at sende data til Google Analytics om den besøgendes enhed og adfærd. Sporer den besøgendepå tværs af enheder og marketingkanaler </td>
                </tr>
                <tr>
                  <td>session_id </td> <td>Bruges til at holde styr på brugere logget ind på sitet </td>
                </tr>
                <tr>
                  <td>SESS# </td> <td>Bevarer brugertilstand på tværs af sideforespørgsler. </td>
                </tr>
                <tr>
                  <td>frontend_lang </td> <td>Bevarer sprogvalg på tværs af sideforespørgsler og sørger for at huske brugers foretrukne sprog. </td>
                </tr>
              </tbody>
            </table>
            </div>
    ...
    <div class="content-section">
        <div class="content-section__wrapper">
            <div class="content-block">
            <h2>Ved almen benyttelse af hjemmesiden</h2>
    ...
    <div class="content-section">
        <div class="content-section__wrapper">
            <div class="content-block">
            <h2>Ved oprettelse og benyttelse af kluboplevelsers service til fundraising</h2>
            <p>Oplysningerne opbevares i det tidsrum jeres fundraising varer + 31 dage. herefter bliver alle data slettet. Data om din brug af websitet, hvilke annoncer, du modtager og evt. klikker på, geografisk placering, køn og alderssegment m.v. videregives til tredjeparter i det omfang disse oplysninger er kendt. Du kan se hvilke tredjeparter, der er tale om, i afsnittet om ”Cookies” ovenfor. Oplysningerne anvendes til målretning af annoncering. Vi benytter herudover en række tredjeparter til opbevaring og behandling af data. Disse behandler udelukkende oplysninger på vores vegne og må ikke anvende dem til egne formål. Videregivelse af personoplysninger som navn og e-mail m.v. vil kun ske, hvis du giver samtykke til det. Vi anvender kun databehandlere i EU eller i lande, der kan give dine oplysninger en tilstrækkelig beskyttelse.</p>
            </div>
        </div>
    </div>
    <div class="content-section">
    ...
    <div class="content-section">
        <div class="content-section__wrapper">
            <div class="content-block">
            <h2>Udgiver</h2>
            <p>Websitet ejes og publiceres af: <br /> Kluboplevelser.dk ApS <br />39690330<br />Rugårdsvej 253<br />5210, Odense SV<br />Email: info@kluboplevelser.dk</p>
            </div>
        </div>
    </div>
    </div>
