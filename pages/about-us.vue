  ...
  <section class="main-content">
	...
	<div class="content-section">
		<div class="content-section__wrapper">
			...
			<div class="department-grid">
				...
				<div class="department-grid__item">
					<img src="@/assets/img/employees/bahra.jpg" alt="" class="employee-img">
		...
		<div class="content-section__wrapper">
			...
			<div class="department-grid">
				...
				<div class="department-grid__item">
					...
					<p class="employee-jobtitle">Coordinator</p>
					<p class="employee-email"><a href="mailto:hck@swann-studio.com">hck@swann-studio.com</a></p>
				</div>
				<div class="department-grid__item">
				...
				<div class="department-grid__item">
					...
					<p class="employee-email"><a href="mailto:lh@swann-studio.com">lh@swann-studio.com</a></p>
				</div>
			</div>
		</div>
	</div>
	<div class="content-section content-section--bg-color">
		<div class="content-section__wrapper">
			...
			<div class="department-grid">
				...
				<div class="department-grid__item">
					<img src="@/assets/img/employees/tore.jpg" alt="" class="employee-img">
				...
				<div class="department-grid__item">
					...
					<p class="employee-email"><a href="mailto:og@swann-studio.com">og@swann-studio.com</a></p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="content-section">
		<div class="content-section__wrapper">
			...
			<div class="department-grid">
				<div class="department-grid__item">
					<img src="@/assets/img/employees/jane.jpg" alt="" class="employee-img">
